...
fuelGaugeRect = rectangle('Position', [Const.fuelGaugeOffset, Const.fuelGaugeWidth, Const.fuelGaugeMaxHeight]);
...
fuelFillRect = rectangle('Position', [Const.fuelGaugeOffset, Const.fuelGaugeWidth, fuelGaugeHeight]);
