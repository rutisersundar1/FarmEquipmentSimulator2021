...
classdef Const
    properties (Constant)
        ...
        %performance impact.
        blueScreenBGImg = 'backgroundBlueScreen.png'; %bluescreen image
        backgroundImg = 'background.png'; %Path to the background image
        backgroundScale = 1; %Do not change scale values.
        
        rocketImg = 'rocket3.png'; %Path to the rocket image
        rocketScale = 1; %Do not change scale values.
        
        crashedRocketImg = 'rocket3_crashed.png'; %Crashed version of the rocket
        
        %Low/mid/high thrust images (with flames)
        rocketThrust1Img = 'rocket3_low.png';
        rocketThrust2Img = 'rocket3_mid.png';
        rocketThrust3Img = 'rocket3_high.png';
        
        exhaustImg = 'exhaust.png'; %exhaust particle
        dirtImg = 'dirt.png'; %dirt particles
        particleScale = 5; %Scale for the particles

        cowImg = 'cow.png'; %Path to the cow image
        cowScale = 1; %Do not change scale values.
        noneImg = 'noneImg.png'; %1x1 transparent png.
        cowFlyImg = 'cowFly.png'; %flying cow image

        foregroundDepth = 5; %The rocket and cows appear on this depth.
        titleScreenImg = 'titleScreen.png'; %Title screen
        pauseScreenImg = 'pauseScreen.png'; %Pause screen
        crashScreenImg = 'crashScreen.png'; %Crash screen
        
        crashedTractorImg = 'crashedTractor.png' %Crashed tractor obstacle

        tutorial1Img = 'tutorial.png'; %Tutorial screen
